...
// ../../node_modules/.pnpm/get-it@9.5.4/node_modules/get-it/dist/anySignal-BeN17qTs.js
...
// ../../node_modules/.pnpm/get-it@9.5.4/node_modules/get-it/dist/errorGuards-30g5CbJL.js
...
function createRequester(options) {
  ...
  async function performFetch(fetchFn, opts) {
    ...
    if (headersMs !== void 0) {
      let timeoutError = new TimeoutError2({
        url,
        method,
        timeoutMs: headersMs,
        phase: "headers"
...
function buildFetchArgs(opts, totalMs, instanceCredentials) {
  ...
  if (totalMs !== void 0) {
    ...
    unrefTimer(timer2), clearTotalTimer = () => clearTimeout(timer2), signal = signal ? anySignal([signal, totalController.signal]) : totalController.signal;
  }
...
// ../../node_modules/.pnpm/get-it@9.5.4/node_modules/get-it/dist/middleware.js
...
// ../../node_modules/.pnpm/@sanity+client@8.6.2/node_modules/@sanity/client/dist/request-CYLhJzOA.js
var NEWLINE = /\r\n|[\n\r\u2028\u2029]/;
...
//# sourceMappingURL=chunk-YG2ZALVI.js.map
