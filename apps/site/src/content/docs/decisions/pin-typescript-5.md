---
title: ADR-0003 — Pin TypeScript 5.9.3 rather than take `latest`
description: typescript@latest is 7.0.2, the native port of the compiler. Separately, @sanity/workflow-blueprint@0.33.0 declares a peer dependency of typescript@^6.0.3.
group: Decisions
order: 93
status: stable
updated: 2026-09-19
