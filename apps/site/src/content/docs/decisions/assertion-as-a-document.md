---
title: ADR-0005 — Model assertions as documents rather than inferring them
description: When a claim changes, we need every published page that depends on it. Two options:
group: Decisions
order: 95
status: stable
updated: 2026-09-19
