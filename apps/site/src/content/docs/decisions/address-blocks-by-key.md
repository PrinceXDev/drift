---
title: ADR-0007 — Address blocks by `_key`, never by position
description: An assertion records where in a page a claim is expressed. The first implementation stored a positional path — body[1] — because that is the natural thing to capture when extracting an asser
group: Decisions
order: 97
status: stable
updated: 2026-09-19
