---
title: ADR-0004 — Deterministic core, LLM only at the edges
description: The easy version of this product asks a model "what changed between these two knowledge bases?" and renders the answer. That version cannot be trusted, cannot be tested, and gives a user no 
group: Decisions
order: 94
status: stable
updated: 2026-09-19
