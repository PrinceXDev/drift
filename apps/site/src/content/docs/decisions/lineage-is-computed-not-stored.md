---
title: ADR-0013 — Claim lineage is stamped by the ledger, never authored
description: A claim needs a provenance a person can act on: where did this statement come from, when did it appear, when was it last checked, and when did it move.
group: Decisions
order: 103
status: stable
updated: 2026-09-19
